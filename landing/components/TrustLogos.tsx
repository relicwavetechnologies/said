export function TrustLogos() {
  return (
    <div className="flex items-center gap-5 text-[14px] text-muted">
      <span className="whitespace-nowrap">Trusted by winners at</span>
      <ul className="flex items-center gap-5 [&>li]:flex [&>li]:items-center">
        <li aria-label="Amazon">
          <AmazonMark />
        </li>
        <li aria-label="Notion">
          <NotionMark />
        </li>
        <li aria-label="Snowflake">
          <SnowflakeMark />
        </li>
      </ul>
    </div>
...
function AmazonMark() {
  return (
    <svg viewBox="0 0 60 28" width="56" height="22" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <path
...
function NotionMark() {
  return (
    <svg viewBox="0 0 24 24" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <path
        d="M7.5 7v10M7.5 7l9 10M16.5 7v10"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
